...
import (
	...
	"github.com/lazhari/url-shortener/serializer/json"
	"github.com/lazhari/url-shortener/serializer/msgpack"

	"github.com/lazhari/url-shortener/shortener"
)

// RedirectHandler represents the interface for redirect handler
